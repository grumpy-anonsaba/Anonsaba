...
{% block content %}
	...
	<div class="login">
		Logged in as <span class='strong'>{{name}}</span> Private Messages <a href="index.php?side={{current}}&action=pms">[{{privmsg}}]</a> [<a href="index.php?action=logout">Log Out</a>]
	</div>
	<nav>
	<ul>
	...
	{% endif %}
	{% if stafflevel == "2" or stafflevel == "1" or stafflevel == "3" %}
